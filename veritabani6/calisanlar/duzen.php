...
try{
 ...
 if($_POST){
  ...
  if($direksiyonid!="" && $direksiyonad!=""){
    $sonuc = $conn->exec("UPDATE calisanlar SET  calisanlar_ad ='$calısanad' WHERE calisanlar_id='$calısanid'");
  }else{
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Çalışanları Düzenle</h1>
                    </div>
...
<div class="table-responsive">
  ...
  <tr ><th style='text-align:center;'>Çalışan Ad</th>
...
try{
 ...
 $query = $conn->query("SELECT * FROM calisanlar ");

 while ($row = $query->fetch()) {
  echo "<tr ><td style='text-align:center;'>".$row['calisanlar_ad']."</td>";
  echo "<td style='text-align:center;'> <button class='calisanduzen' id=".$row['calisanlar_id'].">Düzenle</button></td></tr>";
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Çalışanları duzenle</h5>
    ...
    <input type="hidden" value="" id="calısanid" name="id">
