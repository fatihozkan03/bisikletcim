...
try{
 ...
 if($_POST) 
		...
		if($sonuc = $conn ->query("DELETE FROM odeme WHERE odeme_id=$id")==true){
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ödeme Sil</h1>
                    </div>
...
<tr ><th style='text-align:center;'>Sahıs</th>
<th style='text-align:center;'>Ödeme Toplam</th>
...
echo "<form form action='sil.php' method='post'><td style='text-align:center;'> <input type='hidden' name='id'value='".$row['odeme_id']."'> <input type='submit'value='Sil' ></form>";
}
