...
try{
 ...
 if($bdurum!="" ){
$query=$conn->exec("insert into calisandurum (calisan_ad,calisan_durum )VALUES('$bdurum','$durum')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Çalışan  Durumu Ekle</h1>
                    </div>
...
?>
  <form action="ekle.php" method="post">
    ...
    <label for="fname">Calısan Ad</label>
    <input type="text" id="ad" name="ad"  placeholder="ad">
    <select class="form-control" name="durum">
    <option >Çalışır</option>
    <option >Çekimser</option>
    <option >Çalışmaz</option>
    </select>
